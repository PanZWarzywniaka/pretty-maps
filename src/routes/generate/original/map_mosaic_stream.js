...
import { fitDim } from './viewport'
import {mapImageStream} from './map_image_stream'
...
function mapMosaicStream (style, mapDiv, opts) {
  ...
  var viewport = fitDim(map, dpDim, bbox)
  ...
  var complete = 0
  var out = pumpify(mapMosaic, spy(onChunk), pngStream)
